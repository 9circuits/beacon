    ...
    $("#loginDialog").dialog({
        ...
        buttons: {
            Login: function() {
                ...
                bValid = bValid && checkLength1(password1,"password",5,16);
                bValid = bValid && checkRegexp1(name1,/^[a-z]([0-9a-z_])+$/i,"Username may consist of a-z, 0-9, underscores, begin with a letter.");
                bValid = bValid && checkRegexp1(password1,/^([0-9a-zA-Z])+$/,"Password field only allow : a-z 0-9");
                if (bValid) {
                    $("#loginForm").submit();
                }
            },
    ...
    $("#installDialog").dialog({
        ...
        buttons: {
            Install: function() {
                ...
                bValid = bValid && checkLength2(password2,"password",5,16);
                ...
                bValid = bValid && checkRegexp2(password2,/^([0-9a-zA-Z])+$/,"Password field only allow : a-z 0-9");
                if (bValid) {
                    $("#installForm").submit();
                }
            },
